...
namespace Patient.Infrastructure.Migrations
{
    ...
    [Migration("20241007110206_doctorPropertySpecializationChanged")]
    partial class doctorPropertySpecializationChanged
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Patient.Domain.Entities.MedicalRecommandation", b =>
                {
                    ...
                    b.Property<bool>("AskForVisitOnline")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("DoesPatientChecked")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Patient.Domain.Entities.PatientsDisease", b =>
                {
                    ...
                    b.Property<string>("UserExperienceWithDisease")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Patient.Domain.Entities.Actors.Doctor", b =>
                {
                    ...
                    b.Property<string>("DoctorSpecializations")
                        .HasColumnType("nvarchar(max)");
